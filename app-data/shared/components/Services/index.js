        ...
        <Container>
            <Row>
              <Col lg="6" sm="12" className="pt-4 services_holder" onClick = { () => handleToggle(0)}>
                <div className={ isOpen[0] ? "service_content d-flex align-items-center flex-column justify-content-center" : "service_content d-flex align-items-center flex-column justify-content-center"} >
              ...
              <Col lg="6" sm="12" className="pt-4 services_holder" onClick = { () => handleToggle(1)}>
                <div className={ isOpen[1] ? "service_content d-flex align-items-center flex-column justify-content-center " : "service_content d-flex align-items-center flex-column justify-content-center "} >
                ...
                <div  className={isOpen[1] ? " service d-flex align-items-center justify-content-center hide" : "service d-flex align-items-center justify-content-center show"}>
                  <h2 className="text-center">SLUŽBY<br/>INFORMÁTORA</h2>
                </div>
              </Col>
              <Col lg="6" sm="12" className="pt-4 services_holder"  onClick = { () => handleToggle(2)}>
                <div className={ isOpen[2] ? "service_content d-flex align-items-center flex-column justify-content-center " : "service_content d-flex align-items-center flex-column justify-content-center "} >
